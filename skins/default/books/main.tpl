...
if(isset($_GET['author'])) {?>
	...
	<div class="prod-info"><?php
		echo '<span class="prod-parameter">Имя автора: </span>'.hc($row['name']).'<br><span class="prod-parameter">Об авторе: </span>'.hc($row['description']).'<br><span class="prod-parameter">Книги автора: </span>';
